...
export default function EarthingProductsPage() {
  ...
  useEffect(() => {
    ...
    fetch(`${apiBase}/products`)
      ...
      .then((data: Product[]) => {
        setProducts(data.filter((p: Product) => p.category === 'earthing-products'));
      })
      .catch(() => {
        setProducts(allProducts.filter(p => p.category === 'earthing-products'));
      });
  }, []);
  return (
        ...
        <div className="max-w-7xl mx-auto px-6">
          <div className="flex flex-col md:flex-row justify-between items-center md:items-end mb-16 md:mb-20 gap-8 text-center md:text-left">
            <div className="max-w-xl">
              <h2 className="text-3xl md:text-5xl font-black uppercase tracking-tighter mb-4">The Collection</h2>
