  ...
  return (
    <>
      ...
      <div className="relative w-full">
        {/* Global 3D Cable Sidebar Positioned on the Left - Made visible but narrow on mobile */}
        <div className="absolute left-0 top-0 w-[60px] md:w-[10%] h-full z-[50] pointer-events-none lg:pointer-events-auto">
          <div className="sticky top-0 h-screen w-full overflow-hidden flex items-start justify-center">
            <div className="w-full h-full relative">
              <ProductCable />
            </div>
            
            <div className="hidden lg:block absolute -left-10 top-1/2 -rotate-90 origin-center select-none pointer-events-none opacity-[0.04] mix-blend-difference">
