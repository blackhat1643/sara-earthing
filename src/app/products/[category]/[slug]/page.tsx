...
export default function ProductDetailPage() {
  ...
  const tabs = [
    ...
    ...(product?.detailedTabs?.advantages ? [{ id: 'advantages', label: 'Key Advantages' }] : []),
    ...(product?.detailedTabs?.specTable || product?.specs ? [{ id: 'specs', label: 'Specifications' }] : []),
      ...
      <div className="fixed top-24 left-0 right-0 z-40 px-6">
        <div className="max-w-7xl mx-auto">
          ...
          >
            ...
            Back to {getCategoryLabel(category as string)}
          </button>
        </div>
      </div>
            ...
            >
              <div>
                <div className="flex items-center gap-4 mb-6">
                  ...
                  <span className="text-[#d4af37] text-sm font-black uppercase tracking-[0.4em]">{getCategoryLabel(category as string)}</span>
                </div>
