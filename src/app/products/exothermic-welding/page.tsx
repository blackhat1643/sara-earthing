...
export default function ExothermicWeldingPage() {
  const products = allProducts.filter(p => p.category === 'exothermic-welding');
  return (
          ...
          <div className="grid lg:grid-cols-2 gap-10 md:gap-16 items-center">
            ...
            >
              <div className="flex items-center justify-center lg:justify-start gap-4 mb-8">
                ...
                <span className="text-[#d4af37] text-sm font-black uppercase tracking-[0.4em]">Section 03</span>
              </div>
              <h1 className="text-4xl md:text-8xl font-black uppercase tracking-tighter leading-[1.1] md:leading-[0.8] mb-8">
                Pure <br />
                <span className="text-[#d4af37]">Fusion</span>
              </h1>
              <p className="text-slate-500 text-lg md:text-xl max-w-md mx-auto lg:mx-0 leading-relaxed font-medium">
                Molecular bonding technologies for permanent, corrosion-free electrical connections that never loosen over time.
              </p>
            </motion.div>
            ...
            >
              <Image 
                src="/images/VIEW/20-08-2025 Sara Earthing1056.JPG" 
                alt="Exothermic Welding" 
                fill 
        ...
        <div className="max-w-7xl mx-auto px-6">
          <div className="flex flex-col md:flex-row justify-between items-center md:items-end mb-16 md:mb-20 gap-8 text-center md:text-left">
            <div className="max-w-xl">
              <h2 className="text-3xl md:text-5xl font-black uppercase tracking-tighter mb-4">Molecular Bonds</h2>
              <div className="h-1.5 w-24 bg-[#d4af37] mx-auto md:ml-0" />
            </div>
            <p className="text-slate-400 font-bold uppercase tracking-widest text-[10px]">
              Explore permanent connection technology
            </p>
          </div>
      ...
      <section className="py-20 bg-[#d4af37] text-white">
        <div className="max-w-7xl mx-auto px-6 flex flex-col md:flex-row items-center justify-between gap-12">
          <div className="max-w-2xl">
            <h2 className="text-4xl md:text-6xl font-black uppercase tracking-tighter mb-4 leading-none">Molecular <br /> Certainty</h2>
            <p className="text-white/80 text-lg font-medium">ESTWELD® process creates permanent bonds that withstand the test of time and environmental stress.</p>
          </div>
