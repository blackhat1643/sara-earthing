...
export default function ClientStrip() {
  ...
  return (
    <section className="bg-[#050810] py-8 md:py-6 relative overflow-hidden border-t border-white/5">
      {/* Background Accent */}
      ...
      <div className="w-full flex flex-col items-center relative z-10">
        ...
        <div className="relative w-full flex overflow-hidden">
          ...
          <div className="flex animate-marquee gap-4 md:gap-6 items-center will-change-transform hover:[animation-play-state:paused] py-3">
            {multiplied.map((c, i) => (
              <div
                key={i}
