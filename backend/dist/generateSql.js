...
// Define paths
const submissionsPath = path_1.default.join(__dirname, 'data', 'submissions.json');
const productsPath = path_1.default.join(__dirname, 'data', 'products.json');
const metadataPath = path_1.default.join(__dirname, 'data', 'metadata.json');
const blogsPath = path_1.default.join(__dirname, 'data', 'blogs.json');
const outputPath = path_1.default.join(process.cwd(), 'sara_earthing.sql');
...
if (fs_1.default.existsSync(submissionsPath)) {
    const data = JSON.parse(fs_1.default.readFileSync(submissionsPath, 'utf-8') || '[]');
    if (data.length > 0) {
...
if (fs_1.default.existsSync(productsPath)) {
    const data = JSON.parse(fs_1.default.readFileSync(productsPath, 'utf-8') || '[]');
    if (data.length > 0) {
...
if (fs_1.default.existsSync(metadataPath)) {
    const data = JSON.parse(fs_1.default.readFileSync(metadataPath, 'utf-8') || '{}');
...
if (fs_1.default.existsSync(blogsPath)) {
    const data = JSON.parse(fs_1.default.readFileSync(blogsPath, 'utf-8') || '[]');
    if (data.length > 0) {
...
fs_1.default.writeFileSync(outputPath, sql, 'utf-8');
